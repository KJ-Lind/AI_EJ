...
# UI
title = tk.Label(Window, text="Markov chain simulator", font=("Arial", 20), bg="grey")
title.pack(pady=50)

label_A = tk.Label(Window, text="Chances of going to A",bg="grey")
label_A.pack()
...
label_B = tk.Label(Window, text="Chances of going to B", bg="grey")
label_B.pack()
